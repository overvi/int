...
addPeriods.addEventListener("click", () => {
                    ...
                    <div class="w-full" >
                      ...
                      >
                        ...
                        <button
                          ...
                          class="bg-red-500/15 delete-period opacity-30 me-1 basis-[30%] text-sm font-bold border border-red-500 rounded-full text-red-500 min-h-8 min-w-[7.125rem]"
                        >
                          Delete
                        </button>
                      </div>
  ...
  document.querySelector(`[data-remove-period="period-${uniqueId}"]`).addEventListener("click", (ev) => {
  ...
  addRow.addEventListener("click", () => {
    ...
    trow.innerHTML = ` 
      <td>
        <div class="p-4 ps-8">
          <div class="select relative border overflow-hidden rounded-full">
            <select name="from-age-${tableRows}" id="from-age-${tableRows}" aria-label="From Age"
      ...
      <td>
        <div class="p-4">
          <div class="select relative border overflow-hidden rounded-full">
            <select name="to-age-${tableRows}" id="to-age-${tableRows}" aria-label="To Age"
              class="appearance-none theme-secondary rounded-full [&:has(option:disabled:checked)]:text-gray-200 w-full min-h-10 ps-[14px] outline-none">
              <option disabled selected value="">Select...</option>
              <option class="text-black" value="1">1</option>
              <option class="text-black" value="2">2</option>
      ...
      <td>
        <div class="p-4">
          <div class="flex w-fit items-center p-1 *:*:cursor-pointer text-sm theme-primary rounded-2xl">
            <div>
              <input type="radio" class="hidden peer" id="infant-${tableRows}" checked name="t-${tableRows}" />
            ...
            <div>
              <input type="radio" class="hidden peer" name="t-${tableRows}" id="child-table-${tableRows}" />
