...
new Litepicker({
  element: document.getElementById("start-date-single"),
});
new Litepicker({
  element: document.getElementById("end-date-single"),
});

new Litepicker({
  element: document.getElementById("start-date-double"),
});
new Litepicker({
  element: document.getElementById("end-date-double"),
});

new Litepicker({
  element: document.getElementById("start-date-triple"),
});
new Litepicker({
  element: document.getElementById("end-date-triple"),
});
    ...
    if (event.target.name === 'refundable?') {
      if (event.target.id === 'refundable') {
        if (!document.getElementById("release-field")) {
          ...
          <div
            class="theme-secondary flex items-center gap-2 border outline-none w-full placeholder:text-gray-400 px-3.5 rounded-full"
          >
            <svg
              width="24"
              height="24"
            ...
            <input
              ...
              name="release-date"
              value="0"
              class="placeholder:text-sm w-28 min-h-10 outline-none"
              id="releaste-datee"
              type="number"
            />
          </div>
